...
- **Playground:** http://localhost:5173 (run `pnpm --filter @tuxe/browser dev`)
...
**@tuxe/browser Package Improvements:**
...
- ✅ Fixed @tuxe/node examples to use `parent:` property
- ✅ Created comprehensive READMEs for @tuxe/node and @tuxe/blessed
...
**@tuxe/browser - API Simplification & Playground:**
