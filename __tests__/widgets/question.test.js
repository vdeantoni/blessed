...
import Question from '../../lib/widgets/question.js';
...
describe('Question', () => {
  ...
  describe('ask()', () => {
    ...
    it('should register keypress handler', () => {
      ...
      expect(question.onScreenEvent).toHaveBeenCalledWith('keypress', expect.any(Function));
    });
  });
  ...
  describe('cleanup', () => {
    ...
    it('should remove keypress listener', () => {
      ...
      expect(question.removeScreenEvent).toHaveBeenCalledWith('keypress', expect.any(Function));
    });
    ...
    it('should remove okay button listener', () => {
      ...
      expect(question._.okay.removeListener).toHaveBeenCalledWith('press', expect.any(Function));
    });
    ...
    it('should remove cancel button listener', () => {
      ...
      expect(question._.cancel.removeListener).toHaveBeenCalledWith('press', expect.any(Function));
    });
  });
  ...
  describe('common use cases', () => {
    it('should create a confirmation dialog', () => {
      ...
      expect(question.content).toContain('Are you sure you want to delete this file?');
    });
