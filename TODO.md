...
1. Add `runtime: Runtime` property to Node class (packages/tuxe-core/src/widgets/node.ts:28)
...
**Files to modify:**
- `packages/tuxe-core/src/widgets/node.ts` (add property + initialization)
- `packages/tuxe-core/src/widgets/screen.ts` (5 usages)
- `packages/tuxe-core/src/widgets/overlayimage.ts` (11 usages)
- `packages/tuxe-core/src/widgets/element.ts` (1 usage + module-level nextTick)
- `packages/tuxe-core/src/widgets/log.ts` (1 usage)
- `packages/tuxe-core/src/widgets/bigtext.ts` (1 usage)
- `packages/tuxe-core/src/widgets/ansiimage.ts` (1 usage)
- `packages/tuxe-core/src/widgets/filemanager.ts` (2 usages)
- `packages/tuxe-core/src/widgets/screen-header.ts` (1 usage)
...
- `packages/tuxe-core/src/index.ts`
- `packages/tuxe-core/src/widgets/screen.ts`
- `packages/tuxe-core/src/lib/program.ts`
- `packages/tuxe-core/src/widgets/ansiimage.ts`
- `packages/tuxe-core/src/lib/image-renderer.ts`
- `packages/tuxe-core/src/widgets/screen-header.ts`
- `packages/tuxe-core/src/widgets/element.ts`
...
**Files to modify:**
- `packages/tuxe-core/src/widgets/overlayimage.ts` (4 instances)
- `packages/tuxe-core/src/lib/tput.ts` (6 instances)
...
**Files to modify:**
- `packages/tuxe-core/src/widgets/ansiimage.ts` (~2 vars)
- `packages/tuxe-core/src/widgets/overlayimage.ts` (~39 vars)
- `packages/tuxe-core/src/lib/program.ts` (~12 vars)
- `packages/tuxe-core/src/lib/tput.ts` (~52 vars)
...
**Description:**
Investigate if we can switch from our custom EventEmitter implementation to using the runtime's event emitter, while having tuxe-node use Node.js's native event emitter.

**Current state:**
- Custom EventEmitter implementation in tuxe-core
- tuxe-node likely wraps or extends this
...
3. Identify Node.js EventEmitter integration points in tuxe-node
...
- Leverage native Node.js EventEmitter in tuxe-node
