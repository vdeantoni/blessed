/**
 * @tuxe/node - Node.js runtime adapter for @tuxe/core
 *
 * This package wraps Node.js APIs and provides them to @tuxe/core through
 * the Runtime interface. It also exposes a modern, tree-shakeable API.
 */

import type { Runtime } from '@tuxe/core';
import { setRuntime, Screen } from '@tuxe/core';
import fs from 'fs';
...
// Re-export all widgets from @tuxe/core
