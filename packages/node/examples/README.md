...
Simple examples demonstrating how to use @tuxe/node.
...
The runtime initializes automatically when you import from `@tuxe/node`. Just import and use:
...
- Explore widget options in [@tuxe/core types](../../core/src/types/options.ts)
