...
import xtermData from '@tuxe/core/data/terminfo/xterm-256color.json' assert { type: 'json' };
import terU14n from '@tuxe/core/data/fonts/ter-u14n.json' assert { type: 'json' };
import terU14b from '@tuxe/core/data/fonts/ter-u14b.json' assert { type: 'json' };
