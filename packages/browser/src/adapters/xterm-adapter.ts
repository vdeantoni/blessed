/**
 * xterm.js adapter for @tuxe/core
 *
 * This adapter bridges @tuxe/core's Program interface to xterm.js Terminal,
...
/**
 * XTermAdapter bridges @tuxe/core's Program API to xterm.js
 *
 * Usage:
 * ```ts
