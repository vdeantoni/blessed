/**
 * Tuxe Playground
 * Interactive code execution environment for @tuxe/browser
 */

import { Terminal } from 'https://cdn.jsdelivr.net/npm/xterm@5.3.0/+esm';
import { FitAddon } from 'https://cdn.jsdelivr.net/npm/@xterm/addon-fit@0.10.0/+esm';
import * as tuxe from '../../dist/index.js';
...
export class BlessedPlayground {
  ...
  async run(code) {
    try {
      ...
      // Create sandboxed function with tuxe and screen in scope
