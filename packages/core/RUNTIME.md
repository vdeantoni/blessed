...
Layer 1: Runtime Interface (@tuxe/core/src/runtime.ts)
...
- Optional: Used by SPECIFIC widgets (images, terminal, GPM)
  ...
  ---
Layer 2: Runtime Context (@tuxe/core/src/runtime-context.ts)
...
- Singleton pattern
  ...
  ---
B. @tuxe/browser - Browser Runtime
...
1. @tuxe/core/src/runtime.ts defines interfaces (what platforms must provide)
2. @tuxe/core/src/runtime-context.ts holds global singleton (getRuntime/setRuntime)
3. Platform packages implement Runtime interface:
   - @tuxe/node → Real Node.js APIs
   - @tuxe/browser → Polyfills + stubs
