...
// Initialize Node.js runtime for @tuxe/core
setRuntime({
  fs: {
    readFileSync,
    readdirSync,
...
const screen = new Screen({
  smartCSR: true,
  title: '@tuxe/core Demo - Press ESC or q to exit',
  fullUnicode: true,
  dockBorders: true
});
...
const header = new Box({
  ...
  width: '100%',
  height: 3,
  content: '{center}{bold}🎨 @tuxe/core Interactive Demo 🎨{/bold}{/center}',
  tags: true,
  style: {
    fg: 'white',
    bg: 'blue',
...
logBox.add('{bold}@tuxe/core Demo Started!{/bold}');
logBox.add('{green-fg}━━━━━━━━━━━━━━━━━━━━━━━━━{/green-fg}');
logBox.add('');
