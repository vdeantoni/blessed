/**
 * Runtime abstraction layer for @tuxe/core
 *
 * This module defines the Runtime interface that all platform adapters must implement.
 * It abstracts Node.js-specific APIs so that @tuxe/core remains platform-agnostic.
 *
 * Platform adapters:
 * - @tuxe/node: Wraps Node.js fs, path, process, child_process, tty, etc.
 * - @tuxe/browser: Provides browser polyfills for these APIs
 */
 ...
 * All @tuxe/core modules accept this interface for platform operations
 */
