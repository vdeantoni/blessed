...
import blessed, { escape, stripTags, cleanTags, generateTags, colors } from '../src/blessed.js';
...
describe('Integration Tests - Real Blessed Patterns', () => {
  ...
  describe('Style Patterns', () => {
    it('should support inline style tags', () => {
      const box = blessed.box({
        parent: screen,
        content: '{bold}Bold{/bold} {underline}Underline{/underline} {red-fg}Red{/red-fg}',
        tags: true
      });
