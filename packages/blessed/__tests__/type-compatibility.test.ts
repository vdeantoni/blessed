 ...
 *
 * This test verifies that @tuxe/blessed is 100% type-compatible with @types/blessed.
 * It ensures that code written for the original blessed library will work with @tuxe/blessed
