...
class Program extends EventEmitter {
  ...
  [key: string]: any;
    ...
    constructor(options?: any, legacyOutput?: any) {
        ...
        // OSX
        this.isOSXTerm = ENV_TERM_PROGRAM === 'Apple_Terminal';
        this.isiTerm2 = ENV_TERM_PROGRAM === 'iTerm.app'
            || !!ENV_ITERM_SESSION_ID;
        ...
        this.isXFCE = /xfce/i.test(ENV_COLORTERM);
        this.isTerminator = !!ENV_TERMINATOR_UUID;
        this.isLXDE = false;
        this.isVTE = !!ENV_VTE_VERSION
            || this.isXFCE
            || this.isTerminator
            || this.isLXDE;

        // xterm and rxvt - not accurate
        this.isRxvt = /rxvt/i.test(ENV_COLORTERM);
        this.isXterm = false;
