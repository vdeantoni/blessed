...
alias.strings = {
  ...
  'set_left_margin':                                       ['smgl',                               'ML'], //                                set left soft margin at current col‐ umn.       See smgl and smgr.
  ...
  'set_tab':                                               ['hts',                                'st'], //                                set a tab in every row, current col‐ umns
  ...
  'zero_motion':                                           ['zerom',                              'Zx'], //                                No motion for subse‐ quent character
  ...
  //         Variable                                      Cap-                               TCap                                 Description
  //          String                                       name                               Code
  'alt_scancode_esc':                                      ['scesa',                              'S8'], //                               Alternate escape for scancode emula‐ tion
  ...
  'define_bit_image_region':                               ['defbi',                              'Yx'], //                               Define rectangu‐ lar bit image region
  ...
  'req_mouse_pos':                                         ['reqmp',                              'RQ'], //                               Request mouse posi‐ tion
