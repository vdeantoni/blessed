# tuxe Monorepo Complete Setup Guide
...
│   ├── tuxe-blessed/      # Blessed API compatibility wrapper
│   └── tuxe-browser/      # Browser runtime adapter (xterm.js)
...
### Files to Update
Update `github.com/vdeantoni/blessed` → `github.com/vdeantoni/tuxe` in:

- [x] Root `package.json`
- [x] `packages/blessed/package.json`
- [x] `packages/blessed-browser/package.json`
- [x] `packages/blessed-browser/README.md`
- [x] `packages/tuxe-core/package.json`
- [x] `packages/tuxe-node/package.json`
- [x] `packages/tuxe-blessed/package.json`
- [x] `packages/tuxe-browser/package.json`
...
Copy `packages/blessed/eslint.config.js` to all tuxe packages with adaptations:

**tuxe-core** (platform-neutral):
```js
// Remove Node.js globals, keep minimal config
ignores: ['dist/**', 'node_modules/**', '.turbo/**']
```

**tuxe-node, tuxe-blessed** (Node.js):
```js
// Same as blessed, includes Node.js globals
```

**tuxe-browser** (Browser):
```js
...
**tuxe-core, tuxe-node, tuxe-blessed:**
```ts
...
### Playwright Configuration (tuxe-browser only)
```ts
export default defineConfig({
...
const packages = [
  'tuxe-core',      // No deps
  'tuxe-node',      // Depends on tuxe-core
  'tuxe-browser',   // Depends on tuxe-core
  'tux-blessed',   // Depends on tux-node
  'blessed',       // Independent
...
[![Build](https://github.com/vdeantoni/tuxe/workflows/Tests/badge.svg)](https://github.com/vdeantoni/tuxe/actions)
[![Coverage](https://codecov.io/gh/vdeantoni/tuxe/branch/main/graph/badge.svg)](https://codecov.io/gh/vdeantoni/tuxe)
[![npm version](https://badge.fury.io/js/@tuxe%2Fcore.svg)](https://www.npmjs.com/package/@tuxe/core)
