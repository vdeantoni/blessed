...
$ npm install @tuxe/blessed@alpha

# Or install a specific alpha version
$ npm install @tuxe/blessed@1.0.0-alpha.1
```

> **Note:** This is the modernized fork of blessed. Install `@tuxe/blessed@alpha` to get the latest alpha release with TypeScript support, comprehensive tests, and modern tooling.
